...
<div class="container-fluid">
    ...
    <br/>
    <form class="form-horizontal" role="form" action="rukuEdit" method="post" onsubmit="return check()">
        <input type="hidden" class="form-control" id="id" name="id" value="${vo.id}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="rukuName" name="rukuName" value="${vo.rukuName}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">数量：</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="rukuSuliang" name="rukuSuliang" value="${vo.rukuSuliang}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">入库时间：</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="rukuTime" name="rukuTime" value="${vo.rukuTime}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">操作员：</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="rukuRen" name="rukuRen" value="${vo.rukuRen}">
                </div>
            </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">备注：</label>
            <div class="col-sm-5">
                <textarea rows="3" class="form-control" id="rukuText" name="rukuText" placeholder="请输入内容......">${vo.rukuText}</textarea>
            </div>
        </div>
        <div class="form-group">
