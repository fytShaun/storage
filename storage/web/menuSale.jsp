...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1 style="text-shadow: 1px 2px #FFFFFF;color: #000000"><%--<img src="img/icon.jpg" class="radius-circle rotate-hover" height="50" alt=""/>--%>仓库进销存管理系统</h1>
    </div>
...
<%--        <li><a href="userList" target="right"><span class="icon-caret-right"></span>用户管理</a></li>--%>
        <li><a href="chukuList" target="right"><span class="icon-caret-right"></span>出库管理</a></li>
        <li><a href="kuchunList" target="right"><span class="icon-caret-right"></span>库存管理</a></li>
<%--        <li><a href="rukuList" target="right"><span class="icon-caret-right"></span>入库管理</a></li>--%>
